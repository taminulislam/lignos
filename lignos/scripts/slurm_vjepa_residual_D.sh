...
#SBATCH --requeue
#SBATCH --output=../jobs/vres_D_%j.out
#SBATCH --error=../jobs/vres_D_%j.err
# Suggestion D: kitchen-sink features (V-JEPA + chemprop + thermo + surface_fp)
