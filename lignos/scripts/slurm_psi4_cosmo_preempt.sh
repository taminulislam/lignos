...
#SBATCH --requeue
#SBATCH --output=../jobs/logs/psi4_pre_%A_%a.out
#SBATCH --error=../jobs/logs/psi4_pre_%A_%a.err

# ============================================================
# Preempt-partition twin of slurm_psi4_cosmo.sh.
# Backfills onto idle nodes; skip-logic on the .npz file
# prevents duplicate work with the main array.
# ============================================================
