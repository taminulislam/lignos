...
#SBATCH --requeue
#SBATCH --output=../jobs/pp_dino_%j.out
#SBATCH --error=../jobs/pp_dino_%j.err
# 80-D hybrid: PCA(Gast V-JEPA, 20) + PCA(DFT V-JEPA, 20) + PCA(DINOv2, 20) + PCA(Supervised, 20)
...
python scripts/perprop_residual.py \
    ...
    --add-dinov2 --dinov2-pca 20 \
    --sup-pca 20 \
    --seeds 10 --epochs 300 --tag hybrid_G20_D20_DINO20_S20
echo "Done: $(date)"
