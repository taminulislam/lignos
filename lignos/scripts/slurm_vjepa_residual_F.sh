...
#SBATCH --requeue
#SBATCH --output=../jobs/vres_F_%j.out
#SBATCH --error=../jobs/vres_F_%j.err
# Suggestion F: per-property specialized correctors (7 MLPs), kitchen-sink features
